...
public class CryptochatActivity extends AppCompatActivity implements View.OnClickListener {
    FirebaseAuth firebaseAuth;
    FirebaseDatabase firebaseDatabase;
    DatabaseReference reference;
    MessageAdapter messageAdapter;
    UserDetails user;
    List<Message> cryptochats;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cryptochat);
    ...
    private void getMessage(){
        ...
        reference = firebaseDatabase.getReference("Crypto Chat");
        reference.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                Message message = dataSnapshot.getValue(Message.class);
                message.setKey(dataSnapshot.getKey());
                cryptochats.add(message);
                displaycryptochats(cryptochats);
    ...
    private void displaycryptochats(List<Message> message) {
        recyclerView.setLayoutManager(new LinearLayoutManager(CryptochatActivity.this));
        messageAdapter = new MessageAdapter(CryptochatActivity.this,message,reference);

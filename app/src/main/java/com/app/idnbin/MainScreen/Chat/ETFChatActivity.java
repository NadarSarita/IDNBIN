...
public class ETFChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_t_f_chat);
    ...
    private void getMessage(){
        ...
        reference = firebaseDatabase.getReference("ETF Chat");
    ...
    private void displayMessages(List<Message> message) {
        recyclerView.setLayoutManager(new LinearLayoutManager(ETFChatActivity.this));
        messageAdapter = new MessageAdapter(ETFChatActivity.this,message,reference);
